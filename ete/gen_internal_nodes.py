...
This script generates internal nodes by calling get_lineage
...
ncbi = NCBITaxa()
df=pd.read_csv("boacsv.txt", names=['taxid','CDS','CDS_Mean','exon','exon_Mean','gene','gene_Mean','mRNA','mRNA_Mean'])
taxid_list=df['taxid']
